        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="mt-6 flex space-x-4">
              <a href="https://github.com/JiuRanYa" className="text-gray-500 hover:text-gray-800">
              ...
              <a href="https://x.com/JiuRanYa_" className="text-gray-500 hover:text-gray-800">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a href="mailto:siyuantong7@gmail.com" className="text-gray-500 hover:text-gray-800">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
