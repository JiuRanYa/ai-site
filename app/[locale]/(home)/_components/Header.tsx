        ...
        <DropdownMenuContent className="w-[800px] p-0" side="bottom" align="start">
         <div className="grid grid-cols-2 gap-4 p-4">
          ...
          <Link href="/new-ais" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
          ...
          {/* 最多保存的AI */}
          <Link href="/most-saved" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
          ...
          {/* 使用最多的AI */}
          <Link href="/most-used" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* AI Apps */}
          <Link href="/ai-apps" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Discord of AI */}
          <Link href="/discord-ai" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
          ...
          {/* AI Chrome 扩展 */}
          <Link href="/chrome-extensions" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
           ...
           <div className="ml-4">
            <p className="text-base font-medium text-gray-900">{t('chromeExtensions.title')}</p>
            <p className="mt-1 text-sm text-gray-500">{t('chromeExtensions.description')}</p>
           </div>
          </Link>

          {/* GPTs */}
          <Link href="/gpts" className="flex items-start p-3 rounded-lg hover:bg-gray-50">
           <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded bg-indigo-100 text-indigo-600">
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
           ...
           <div className="ml-4">
            <p className="text-base font-medium text-gray-900">{t('gpts.title')}</p>
            <p className="mt-1 text-sm text-gray-500">{t('gpts.description')}</p>
           </div>
          </Link>
         </div>
        </DropdownMenuContent>
